...
# Build repo
flatpak-builder $GPG_SETTINGS --verbose --force-clean --ccache --require-changes --keep-build-dirs --repo=repo --subject="Build of $APP_NAME" app $APP_NAME/$APP_NAME.json
